...
async function handler(req, res) {
    const { id  } = req.query;
    try {
        const response = await fetch((0,_lib_tmdb__WEBPACK_IMPORTED_MODULE_0__/* .getMovieDetail */ .d0)(id));
        const response2 = await fetch((0,_lib_tmdb__WEBPACK_IMPORTED_MODULE_0__/* .getMovieCasts */ .vQ)(id));
...
var __webpack_exports__ = __webpack_require__.X(0, [2110], () => (__webpack_exec__(6427)));
