...
async function handler(req, res) {
    const { id  } = req.query;
    try {
        const url = (0,_lib_tmdb__WEBPACK_IMPORTED_MODULE_0__/* .getUrl2 */ .uL)(_lib_tmdb__WEBPACK_IMPORTED_MODULE_0__/* .tvAiringToday */ .VD, id);
...
var __webpack_exports__ = __webpack_require__.X(0, [2110], () => (__webpack_exec__(2881)));
